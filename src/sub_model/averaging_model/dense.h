...
Description
  ...
  the average particle velocity inside a CFD cell. The “dense” model
...
//! \brief dense
class dense : public averagingModel {
 public:
  //! \brief Runtime type information
  cfdemTypeName("dense");

  cfdemDefineNewFunctionAdder(averagingModel, dense);

  //! \brief Constructor
  dense(cfdemCloud& cloud);
