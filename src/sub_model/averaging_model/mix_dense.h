...
#ifndef __MIX_DENSE_H__
#define __MIX_DENSE_H__
...
class mixDense : public averagingModel {
 public:
  ...
  cfdemTypeName("mixDense");

  cfdemDefineNewFunctionAdder(averagingModel, mixDense);

  //! \brief Constructor
  mixDense(cfdemCloud& cloud);
