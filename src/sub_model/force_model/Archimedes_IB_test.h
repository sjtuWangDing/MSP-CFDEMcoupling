...
Description
  ...
  interaction forces) acting on each DEM particle. The ArchimedesIBTest model
  is a model that only used to test other models' validation.
...
#ifndef __ARCHIMEDES_IB_TEST_H__
#define __ARCHIMEDES_IB_TEST_H__
