...
#ifndef __MIX_MEI_LIFT_FORCE_H__
#define __MIX_MEI_LIFT_FORCE_H__

#include "./force_model.h"

namespace Foam {

class mixMeiLiftForce : public forceModel {
 public:
  //! \brief Runtime type information
  cfdemTypeName("mixMeiLiftForce");

  cfdemDefineNewFunctionAdder(forceModel, mixMeiLiftForce);

  //! \brief Constructor
  mixMeiLiftForce(cfdemCloud& cloud);
 ...
 protected:
  void setForceKernel(const int index, Foam::vector& mixLiftForce);
...
#endif  // __MIX_MEI_LIFT_FORCE_H__
