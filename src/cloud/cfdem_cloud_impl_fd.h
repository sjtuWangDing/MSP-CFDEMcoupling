...
Description
  cfdemCloudImplFD derived from cfdemCloud

Class
  Foam::cfdemCloudImplFD
\*---------------------------------------------------------------------------*/

#ifndef __CFDEM_CLOUD_IMPL_FD_H__
#define __CFDEM_CLOUD_IMPL_FD_H__

#include "cloud/cfdem_cloud.h"

namespace Foam {

class cfdemCloudImplFD : public cfdemCloud {
 public:
  //! \brief Constructed from mesh
  cfdemCloudImplFD(const fvMesh& mesh);
  ...
  /*!
   * \brief 更新函数
   * \note used for cfdemSolverImplFD
...
#endif  // __CFDEM_CLOUD_IMPL_FD_H__
